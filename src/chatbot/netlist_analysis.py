...
def build_netlist_summary_prompt(
    ...
    return (
        ...
        "Use ONLY the deterministic facts and bounded netlist text below. The facts "
        "are the source of truth; do not add components, results, or circuit behavior "
        "that is not supported by them.\n\n"
        "Rules:\n"
        "- Write a user-facing observed-facts report; do not expose internal [FACT ...] labels.\n"
        "- Do not use markdown heading levels. Use only the numbered headings exactly as listed.\n"
        "- List only observed active components, directives, includes, nodes, models, "
        "and subcircuit calls.\n"
        "- Preserve counts from COMPONENT_TYPE_COUNTS. Do not summarize five diode lines as two.\n"
        "- Treat commented lines as inactive; do not describe them as executed SPICE.\n"
        ...
        "- Do not say LM7805 will provide, ensures, guarantees, regulates to, or outputs 5V. "
        "Only say the netlist instantiates a subcircuit named lm7805.\n"
        "- Do not use datasheet knowledge, typical operating ranges, dropout voltage, "
        "input voltage limits, or application advice.\n"
        ...
        "- Do not include recommendations, improvements, design advice, or 'ensure/verify' "
        "action items. This is not a design review.\n"
        "- Describe topology only as observed connections. Do not infer purpose beyond "
        "a cautious sentence that the circuit appears intended to use the lm7805 "
        "subcircuit between the listed nodes.\n"
        ...
        "Respond with exactly these five numbered headings and no other headings:\n"

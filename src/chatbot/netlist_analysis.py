...
NETLIST_SYSTEM_PROMPT = (
    ...
    "1. Circuit Summary — components (from Component Lines) and subcircuits (from Subckt Calls)\n"
    "2. Simulation Setup — what simulation command is configured\n"
    "3. Obvious Issues — check for missing ground (if 'gnd' or '0' is present, it is NOT missing), "
